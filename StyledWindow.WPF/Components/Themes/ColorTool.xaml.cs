...
namespace StyledWindow.WPF.Components.Themes
{
    ...
    {
        public ColorToolViewModel ColorToolModel { get; private set; } = new ColorToolViewModel();
        public ColorTool()
        {
            InitializeComponent();
        }
        public class ColorToolViewModel : ViewModel
        {
            ...
            {
                ToggleBaseCommand = Command.New(o => ApplyBase((bool)o));
                ChangeHueCommand = Command.New(ChangeHue);
                ChangeCustomHueCommand = Command.New(ChangeCustomColor);
                ChangeToPrimaryCommand = Command.New(_ => ChangeScheme(ColorScheme.Primary));
                ChangeToSecondaryCommand = Command.New(_ => ChangeScheme(ColorScheme.Secondary));
                ChangeToPrimaryForegroundCommand = Command.New(_ => ChangeScheme(ColorScheme.PrimaryForeground));
                ChangeToSecondaryForegroundCommand = Command.New(_ => ChangeScheme(ColorScheme.SecondaryForeground));
